...
export default function ExportPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-foreground">Export Laporan</h2>
        <p className="text-sm text-muted-foreground">Unduh data piutang & operasional dalam format Excel, CSV, atau PDF</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <Badge variant="secondary">
                  {exportType === 'piutang' ? 'Piutang' : exportType === 'operasional' ? 'Operasional' : 'Semua'}
                </Badge>
              </div>
              <div className="flex justify-between">
            ...
            <Button onClick={handleExport} disabled={loading} className="w-full gap-2 mt-4" size="lg">
